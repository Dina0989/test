...
class PostController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $posts = $em->getRepository('MyBundle:Post')->findAll();
    ...
    {
        $post = new Post();
        $form = $this->createForm('MyBundle\Form\PostType', $post);
    ...
    {
        $deleteForm = $this->createDeleteForm($post);
        $editForm = $this->createForm('MyBundle\Form\PostType', $post);
